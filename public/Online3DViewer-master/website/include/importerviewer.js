...
ImporterViewer.prototype.Init = function (canvasName)
{
	var viewerSettings = {
		...
		//aca cambia el color del render
		// lightDiffuseColor:[52, 144, 221], //original
		lightDiffuseColor:[118, 189, 33], //blue
		// lightDiffuseColor:[189, 118, 33], //celeste
		// lightDiffuseColor:[189, 33, 118], //green


		// lightAmbientColor:[1,1,1]
		// lightAmbientColor:[118, 189, 33] //blue
	};
	...
	this.viewer.SetClearColor (0xdddddd); //background color original
	// this.viewer.SetClearColor (0xaaaaaa); //background color
	this.viewer.Draw ();
